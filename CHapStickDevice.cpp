...
/*!
    ...
    \fn     cHapStickDevice::cHapStickDevice(unsigned int a_deviceNumber)
*/
cHapStickDevice::cHapStickDevice(unsigned int a_deviceNumber) {
    ...
    *************************************************************************/
    ...
    // can the device be used with the left/right hand?
...
/*!
    ...
    \fn         cHapStickDevice::~cHapStickDevice()
*/
...
/*!
    ...
    \fn     int cHapStickDevice::initialize(const bool a_resetEncoders = false)
    \param  a_resetEncoders Ignored; exists for forward compatibility.
    \return Always 0
*/
int cHapStickDevice::initialize(const bool a_resetEncoders) {
    /************************************************************************
        STEP 5:
...
/*!
    ...
    \fn     unsigned int cHapStickDevice::getNumDevices();
...
/*!
    ...
    \fn     int cHapStickDevice::getPosition(cVector3d& a_position)
...
/*!
    ...
    \fn     int cHapStickDevice::getRotation(cMatrix3d& a_rotation)
...
/*!
    ...
    \fn     int cHapStickDevice::getGripperAngleRad(double& a_angle)
    \param  a_angle  Return value.
    \return Return 0 if no error occurred.
*/
int cHapStickDevice::getGripperAngleRad(double& a_angle) {
    // temp variables
    int error = 0;
...
/*!
    ...
    \fn     int cHapStickDevice::setForce(cVector3d& a_force)
...
/*!
    ...
    \fn     int cHapStickDevice::setTorque(cVector3d& a_torque)
...
/*!
    ...
    \fn     int cHapStickDevice::setGripperTorque(double a_gripperTorque)
    \param  a_gripperTorque  Torque command to be sent to gripper.
    \return Return 0 if no error occurred.
*/
int cHapStickDevice::setGripperTorque(double a_gripperTorque) {
    // temp variable
    int error = 0;
...
/*!
    ...
    \fn     int cHapStickDevice::setForceAndTorqueAndGripper(cVector3d& a_force,
    ...
    \return Return 0 if no error occurred.
*/
int cHapStickDevice::setForceAndTorqueAndGripper(cVector3d& a_force, cVector3d& a_torque, double a_gripperTorque) {
    // temp variables
    int error = 0;
    int result = 0;
...
/*!
    ...
    \fn     int cHapStickDevice::getUserSwitch(int a_switchIndex, bool& a_status)
