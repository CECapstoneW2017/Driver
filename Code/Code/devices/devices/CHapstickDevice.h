...
#define C_SUCCESS 1
#define C_ERROR 0
#define MAX_SIGNAL_FORCE 255	// largest expected value on Arduino end
#define JOYSTICK_LENGTH .10		// in millimeters
#define FORCE_SCALING_FACTOR 1.2
